...
A comprehensive Python toolkit for managing, organizing, and valuating your Pokémon Trading Card collection. This project automates the entire workflow from card identification to market valuation and sales preparation.
...
### Required Data
- Pokémon card images (scanned/photographed)
...
YourProject/
├── PokemonCardLists/
│   ├── Card_Sets/          # Generated by Module 1
│   ├── all_sets_full.json  # Generated by Module 1
│   └── pokedex.csv         # For old sets (pre-2002)
├── YourCardCollection/     # Your card images organized by set
│   └── SetName_SETID/
│       └── raw/
│           ├── EN/
│           ├── FR/
...
## 🏷️ Module 2: Card Renamer & Identifier
...
├── Renamed_Cropped/
│   ├── EN/
│   │   ├── Meganium_154_NEO1_EN_FRONT.jpg
│   │   ├── Meganium_154_NEO1_EN_BACK.jpg
│   │   └── ...
│   └── FR/
├── SETID_inventory.csv
└── learning_db_SETID.pkl
```
...
## 📊 Module 4: Inventory CSV Generator
...
## 🛒 Module 5: eBay Listing Creator (WIP)

### ⚠️ Status: Work in Progress - NOT FUNCTIONAL
...
```
Project/
├── PokemonCardLists/           # Card reference database
│   ├── Card_Sets/              # Per-set folders
│   │   └── SetName_SETID/
│   │       ├── CardList_SETID_en.csv
│   │       ├── CardList_SETID_fr.csv
│   │       └── IMG/
│   │           └── setid-001_1.jpg
│   ├── all_sets_full.json      # Set metadata
│   └── pokedex.csv             # For old sets
│
├── YourCardCollection/         # Your cards (organized by set)
│   └── SetName_SETID/
│       ├── raw/                # Original photos (input)
│       │   ├── EN/
│       │   │   ├── img001.jpg  # Front
│       │   │   ├── img002.jpg  # Back
...
│       │   ├── FR/
│       │   └── ...
│       ├── Renamed_Cropped/    # Processed cards (output)
│       │   ├── EN/
│       │   │   ├── CardName_001_SETID_EN_FRONT.jpg
│       │   │   └── CardName_001_SETID_EN_BACK.jpg
│       │   └── FR/
│       ├── SETID_inventory.csv # Set inventory
│       └── learning_db_SETID.pkl # Learning data
│
├── PokemonTCGAPI/
│   └── collection_list.txt     # Master collection list
│
├── TcgPowerTool/
│   └── pokemon_cards_inventory.csv  # Full inventory
│
├── Scripts/                    # Python scripts
│   ├── cards_utils.py
│   ├── Main_Renamer_learning.py
│   ├── Manual_corrector.py
│   ├── CardMarketScrapper.py
│   ├── generate_CSV.py
│   ├── pokemon_API_CardListCsvGenerator.py
│   ├── pokemon_API_CardIMGDownloader.py
│   ├── ebay_listing_creator.py
│   └── ebay_title.py
│
├── cardmarket_all_prices.json  # Price database
├── set_strategy_cache.json     # Scraper strategy cache
...
This project is for personal use. Pokémon and related trademarks are property of Nintendo/Game Freak/Creatures Inc.
